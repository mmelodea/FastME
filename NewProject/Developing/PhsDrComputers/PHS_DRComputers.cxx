...
#include "FS4l_DrComputer.h"
#include "FS4l2j_DrComputer.h"
#include "FSlv2j_DrComputer.h"
...
///DISTANCE ORDERING + NO RESSONANCE CRITERY
double F4l2j_noRes_DrOrder(Float_t Data[6][3][2], Float_t MC[6][3][2]){
  double dpt2, deta2, dphi2, sum_dr = 0, limiar;
  double sum_dpt2 = 0, sum_deta2 = 0, sum_dphi2 = 0, event_distance = -1;
...
double FSlv2j_jet_DrOrder(Float_t Data[4][3][2], Float_t MC[4][3][2]){
...
double FSlv2j_jet_PtOrder(Float_t Data[4][3][2], Float_t MC[4][3][2]){
  double dpt = 0, deta = 0, dphi = 0;
  double sum_dpt2 = 0, sum_deta2 = 0, sum_dphi2 = 0, event_distance = -1;
  int start;
